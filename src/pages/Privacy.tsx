  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name='description'
          content='The ways that your privacy is kept secure and how your data is used.'
        />
      </Helmet>
      <div className='privacy-page legal-page'>
        <div className='content'>
          <section>
            ...
            <p>
              Thank you for choosing DoorDash Recap! This Privacy Policy
        ...
        `}
          ...
          <section>
            ...
            <p>
              The primary purpose of collecting this information is to
              facilitate users in sharing their data via a unique link in the
              future.
            </p>
          </section>
          <section>
            ...
            <p>
              ...
              card' and may also contribute to store name analysis for
          ...
          <section>
            ...
            <p>
              While data cannot be altered or deleted, it can be accessed
              through a unique link or ID.
            </p>
          </section>
          <section>
            <h2>11. User Age</h2>
