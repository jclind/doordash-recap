    ...
    <div className='privacy-page'>
      <div className='content'>
        ...
        <p>
          ...
          how we collect, use, and safeguard the information you entrust to us.
        </p>
        ...
        <p>
          ...
          encompassing various details such as delivery times, order status, and
          store information.
        </p>
        ...
        <p>
          User-specific data can only be accessed by others if they possess the
          unique link or data ID. While freely accessible, it cannot be modified
          once set.
        </p>
        ...
        <p>
          We utilize Firebase, which may use cookies. Additionally, user 'recap'
          data is stored in local storage for a seamless experience.
        </p>

        <h2>9. Notice of Data Storage</h2>

        <p>
          Users are visually informed, with a footnote, that their data will be
          securely saved to the Firestore database.
        </p>

        <h2>10. Data Modification</h2>

        <p>
          While data cannot be altered or deleted, it can be accessed through a
          unique link or ID.
        </p>
        ...
        <p>
          User data is safeguarded by Google Firebase and reinforced by security
          rules implemented in the Firestore database.
        </p>
        ...
        <p>
          ...
          reach out to us at jesselindcs@gmail.com.
        </p>
